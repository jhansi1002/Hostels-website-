...
import "../css/womenstaff.css";

const WomenStaffPage = () => {
  ...
  return (
    <div class="international-staff">
      <button class="back" onClick={() => navigate("/international")} >Back</button>
